                ...
                <tbody>
                    ...
                    <tr>
                        <td class="px-3 px-sm-5 pb-2">
                            ...
                            <p>Click the button below to activate your <strong>{{ $data['APP_NAME'] }}</strong> account.</p>
                            <p class="mb-4">&nbsp;</p>
                            <a href="{{ $data['APP_URL'] }}/verify/{{ $data['user']['verification_code'] }}" class="email-btn">Verify Email</a>
                        </td>
                    </tr>
                </tbody>
            </table>
