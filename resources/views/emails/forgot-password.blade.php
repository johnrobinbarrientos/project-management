                ...
                <tbody>
                    <tr>
                        <td class="px-3 px-sm-5 pt-3 pt-sm-5 pb-3">
                            <h2 class="email-heading text-center">Reset Password</h2>
                        </td>
                    </tr>
                    <tr>
                        <td class="px-3 px-sm-5 pb-2 text-center">
                            ...
                            <a href="{{ $data['APP_URL'] }}/reset-password/{{ $data['user']['forgot_password_code'] }}" class="email-btn">Reset Password</a>
